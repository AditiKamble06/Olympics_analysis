...
def data_over_time(df,col):
    ...
    nations_over_time = df.drop_duplicates(['Year', col])['Year'].value_counts().reset_index().sort_values('edition_id')
    nations_over_time.rename(columns={'edition_id': 'Edition', 'Year': col}, inplace=True)
